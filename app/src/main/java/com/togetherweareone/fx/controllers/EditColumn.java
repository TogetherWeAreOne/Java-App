...
public class EditColumn {
    ...
    public void load(Scene scene) {
        ...
        List<EditColumnExtensionPoint> extensionPoints = Main.pluginManager.getExtensions(EditColumnExtensionPoint.class);

        for (EditColumnExtensionPoint extension : extensionPoints) {
            extension.loadEditColumnModifications(scene);
        }
    }
