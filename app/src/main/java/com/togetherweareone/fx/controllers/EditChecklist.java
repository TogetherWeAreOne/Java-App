...
import com.togetherweareone.fx.extensions.EditChecklistExtensionPoint;
...
public class EditChecklist {
    ...
    public void load(Scene scene) {
        ...
        List<EditChecklistExtensionPoint> extensionPoints = Main.pluginManager.getExtensions(EditChecklistExtensionPoint.class);

        for (EditChecklistExtensionPoint extension : extensionPoints) {
            extension.loadEditChecklistModifications(scene);
        }
    }
